...
const msg = {
rowner: `『✦』 *الأمر ${comando} يستعمل فقط في المجموعات .*`, 
owner: `*『✦』 الأمر ${comando} يستعمل فقط من قبل المطور .*`, 
mods: `*『✦』 الأمر ${comando} يستعمل فقط من قبل مشرف البوت .*`, 
premium: `*『✦』 الأمر ${comando} يتعمل فقط اذا كنت مستخدم مميز .*`, 
group: `*『✦』 الأمر ${comando} يستعمل فقط في المجموعات .*`,
